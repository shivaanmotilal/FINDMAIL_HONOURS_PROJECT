#Shivaan Motilal
#Programme creates a maildir Format inbox
...
mbox = mailbox.Maildir('FINDMAIL/mailboxes/maildir/Example2')
mbox.lock()
try:
...
for dirname, subdirs, files in os.walk('FINDMAIL/mailboxes/maildir/Example2'):
    print (dirname)
