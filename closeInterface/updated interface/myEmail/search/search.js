...
if (ranked.length > 0){
    ...
    // picture.setAttribute('src', "No_Results.png");
    // picture.setAttribute('alt', "We didn't find anything.Try a different keyword");
    // picture.setAttribute('height', '396 px');
    // picture.setAttribute('width', '384px');
    // pictureDiv.appendChild(oImg);
    // document.getElementById("dynamic-list").appendChild(pictureDiv);
    ...
    $("#dynamic-list").append($('<img>', { 
        ...
        title : "Test Image"
         ...
         // code to add the exit search button
